...
output_dir=${1:-/project/flyspeck-candle-runs/cv-polynomial-expression-dim-jet-sound-v1-run-001}
...
exec "$base_dir/restart-with-fragments.sh" \
  ...
  "$repo_dir/candle/test_cv_compute_polynomial_expr_dim_jet_sound.ml"
