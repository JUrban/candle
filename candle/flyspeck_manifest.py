...
OCAML_COMPATIBILITY_SUPPORTED_MEMBERS = {
    ...
    "Num": {
        "abs_num", "add_num", "approx_num_exp", "big_int_of_num",
        "ceiling_num", "compare", "compare_num", "denominator", "div_num",
        "eq_num", "float_of_num", "floor_num", "gcd_num", "ge_num",
        "gt_num", "int_of_num", "is_integer_num", "le_num", "lt_num",
        "max_num", "min_num", "minus_num", "mod_num", "mul_num", "num",
        "num_of_big_int", "num_of_int", "num_of_string", "numerator",
        "power_num", "pred_num", "quo_num", "round_num", "sign_num",
        "string_of_num", "sub_num", "succ_num",
    },
    "Stdlib": {
    ...
    return {
        ...
        "source_normalization_contract": {
            ...
            "runtime_selection_source": (
                "cakeml:candle/prover/candle_boot.ml@0e97a1ab and "
        ...
        "loader_action_contract": {
            ...
            "static_action_source": "cakeml:candle/prover/candle_boot.ml@0e97a1ab",
