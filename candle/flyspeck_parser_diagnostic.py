...
def main() -> None:
    ...
    runner.add_argument("--timeout-seconds", type=int, default=7200)
    runner.add_argument("--max-cpu-seconds", type=int, default=7200)
    runner.add_argument("--max-address-space-gib", type=int, default=24)
    runner.add_argument("--max-output-mib", type=int, default=1)
    runner.add_argument("--cml-heap-size-mib", type=int, default=16384)
