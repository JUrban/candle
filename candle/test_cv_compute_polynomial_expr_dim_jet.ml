...
if hyp candle_q_dim_poly_compile_jet_program <> [] ||
   hyp candle_q_dim_poly_compile_jet_sound <> [] then
  failwith "dimension-generic interval-jet compiler bridge has assumptions";;
