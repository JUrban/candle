          ...
          (Candle_analytic_add
            (Candle_analytic_inv
              (Candle_analytic_poly
                (Candle_poly_add
                  (Candle_poly_const 1 0 0) (Candle_poly_var 0))))
            (Candle_analytic_poly (Candle_poly_const 3 0 0))))) = 5`) then
...
let _ = print_endline
  "CANDLE_CV_ANALYTIC_EXPR_PROGRAM_RESULT constructors=7 analytic_instructions=5 shared_poly_leaves=2 compile_sound=1";;
