...
class GeneratedManifestTests(unittest.TestCase):
    ...
    def test_source_normalizations_are_exact_and_narrow(self):
        ...
        self.assertEqual(contract["entry_count"], 61)
    ...
    def test_loader_has_a_fail_closed_build_mode(self):
        ...
        self.assertIn(
            "List.length candle_flyspeck_normalized_sources <> 60", source,
        )
        ...
        self.assertEqual(len(selected_normalizations), 60)
