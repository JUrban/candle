...
import flyspeck_nonlinear_module_segmentation as segmentation
...
class NonlinearModuleSegmentationTests(unittest.TestCase):
    ...
    def test_exact_segmentation_and_public_interface(self) -> None:
        ...
        self.assertEqual(receipt["chunk_count"], 7)
        self.assertEqual(receipt["marker_count"], 14)
        ...
        self.assertEqual(text.count(segmentation.MARKER_PREFIX), 14)
        self.assertEqual(text.count("module Candle_taylor_interval_chunk_"), 7)
        self.assertEqual(text.count("include Candle_taylor_interval_chunk_"), 7)
        self.assertIn("module Taylor_interval = struct\n", text)
        self.assertTrue(text.endswith(
            "include Candle_taylor_interval_chunk_006;;\nend;;\n"
        ))
    ...
    def test_identity_and_anchor_drift_fail_closed(self) -> None:
        ...
        body = b"prefix" + segmentation.SPLIT_ANCHORS[0][0] + b"suffix"
