...
let candle_poly_dim_accept_scalar_variables =
  [`x1:real`;`x2:real`;`x3:real`;`x4:real`;`x5:real`;`x6:real`];;

let candle_poly_dim_accept_scalar_source =
  `x1 * x6 + x3 pow 2 + -- &1`;;

let candle_poly_dim_accept_lower = replicate `&0` 6;;
let candle_poly_dim_accept_upper = replicate `&1 / &8` 6;;
...
let candle_poly_dim_accept_source,
  ...
  candle_poly_prepare_scalar_fixture
    candle_poly_dim_accept_vector
    candle_poly_dim_accept_scalar_variables
    candle_poly_dim_accept_scalar_source
    candle_poly_dim_accept_lower
    candle_poly_dim_accept_upper;;
