...
base_dir=${CANDLE_FRAGMENT_BASE_DIR:-/project/flyspeck-candle-runs/cv-nonlinear-analytic-taylor-checkpoint-v1}
...
CANDLE_FRAGMENT_BASE_DIR="$base_dir" CANDLE_FRAGMENT_SKIP_ALL_NEEDS=1 \
  ...
  "$repo_root/candle/cv_compute_analytic_expr_jet_check.ml" \
  "$repo_root/candle/test_cv_compute_analytic_expr_jet_check.ml"
