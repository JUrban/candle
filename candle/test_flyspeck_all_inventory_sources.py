...
class AllInventorySourcePreparationTests(unittest.TestCase):
    ...
    def test_exact_all_400_source_only_contract(self) -> None:
        ...
        self.assertEqual(
            ...
            {"exact-normalized": 39, "exact-original": 361},
        )
    ...
    def test_exact_loader_site_and_masking_contract(self) -> None:
        ...
        self.assertEqual(actions["recognized_site_count"], 725)
        self.assertEqual(actions["masked_whole_line_count"], 721)
        self.assertEqual(actions["embedded_retained_count"], 4)
        ...
        self.assertEqual(
            handling.count("retained-exactly-in-source-only-input"), 4,
        )
        self.assertTrue(all(
    ...
    def test_original_and_normalized_identities_are_bound(self) -> None:
        ...
        self.assertEqual((len(original), len(normalized)), (361, 39))
        self.assertIn(
